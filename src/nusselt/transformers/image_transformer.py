...
class ImageTransformer:
    ...
    @staticmethod
    def read_image(file_path, flag='color', float32=True):
    ...
    @staticmethod
    def write_image(img, file_path, params=None, auto_mkdir=True):
        """Write image to file.
    ...
    @staticmethod
    def img2tensor(imgs: list[np.ndarray] | np.ndarray, bgr2rgb=True, float32=True):
